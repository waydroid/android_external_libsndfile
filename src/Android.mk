...
LOCAL_SRC_FILES:= common.c file_io.c command.c pcm.c ulaw.c alaw.c float32.c \
                ...
                ima_oki_adpcm.c chunk.c ogg.c chanmap.c \
                ...
                sds.c svx.c txw.c voc.c wve.c w64.c wav.c xi.c mpc2k.c rf64.c \
                ...
                ALAC/ag_dec.c  ALAC/ag_enc.c  ALAC/ALACBitUtilities.c  ALAC/alac_decoder.c  ALAC/alac_encoder.c  ALAC/dp_dec.c  ALAC/dp_enc.c  ALAC/matrix_dec.c  ALAC/matrix_enc.c \
